...
vetor = [
        'Temp. = 27 °C Max. = 27 °C Min. = 27 °C',
        'Temp. = 27 °C Max. = 27 °C Min. = 27 °C',
        'Temp. = 28 °C Max. = 28 °C Min. = 27 °C',
        'Temp. = 28 °C Max. = 28 °C Min. = 27 °C',
        'Temp. = 29 °C Max. = 29 °C Min. = 27 °C',
        'Temp. = 30 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 30 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 30 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 29 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 29 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 29 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 28 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 28 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 28 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 27 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 27 °C Max. = 30 °C Min. = 27 °C',
        'Temp. = 27 °C Max. = 30 °C Min. = 27 °C'
        ]
